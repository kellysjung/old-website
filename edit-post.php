...
<div class='main'>
	<div class='blogPosts'>
		<form class='editForm' action='update-post.php' method='POST'>
			...
			<?php postBtns(); ?>
			<input class='defaultBtn' type='submit' name='update' value='Update Post'><br><br>
			<input class='redBtn' type='submit' name='delete' value='Delete Post'>
		</form>
		<p>EDIT TAGS</p>
		<a href = edit-tags.php?postId=<?php echo $postId; ?> name='delete' type='button'><i class='fa fa-tags' aria-hidden='true'></i></a>
