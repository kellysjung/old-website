...
<div class='main'>
	<div class='blogPosts'>
		<form class='postForm' action='update-post.php' method='POST'>
			...
			<textarea name='body' class='postFormBody' rows='10' cols='70' required><?php echo $post['body']; ?></textarea><br><br>
